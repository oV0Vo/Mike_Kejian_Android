...
public class HottestPostListFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_hottest_post_list, null);
        ctx = this.getActivity();
        this.container = (LinearLayout) view.findViewById(R.id.hottest_post_container);
        initData();
        initViews();
        return view;
    ...
    private void initData(){
        this.posts = CampusBLService.getHottestPostList();
