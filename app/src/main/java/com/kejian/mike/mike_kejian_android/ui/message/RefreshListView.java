...
public class RefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private int currentState = NORMAL; // 头布局的状态: 默认为下拉刷新状态
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.layout_message_list_footer, null);
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.layout_message_list_header, null);
